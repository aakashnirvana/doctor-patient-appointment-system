...
m=c.indexOf('p');
		...
		<b>Date:->&nbsp<input type=text name=t1 value="<%=date%>"></b>
	</div>
		<br>
		
		
		 <br>
		<p style="color:green;" align=center><u><b>GREEN: slot available</b></u></p>
		<br>
		<p style="color:red;" align=center><u><b>RED: no slot available<b></u></p>
		<br>
		<p style="color:blue;" align=center>BLUE: your slot</p>
		<br>
		<br>
	...
	if(chekapp)
			...
			{
				out.println("No Appointment Available");
			}
			%>
