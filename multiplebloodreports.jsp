...
<body>
	...
	<h1 class="heading">Blood Report</h1>
	...
	<%
		try
		{
			...
			out.println("<table class='vtable' border='1' cellspacing='0'>");
			out.println("<tr>");
			...
			while(rs.next())
			{
				...
				%>
					<a href='manualbloodreports.jsp?reportid=<%=rs.getString("reportid")%>'><%=date[2]+"-"+date[1]+"-"+date[0]%></a>
				<%
				out.println("</td>");
				out.println("</tr>");
			}
