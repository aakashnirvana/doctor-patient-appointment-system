...
<form action="http://127.0.0.1:8080/das/updatetemp.jsp">
<%		
	...
	try
	{
		...
		ResultSet rs; 
		rs=stmt.executeQuery("select * from templateappointment where temp='"+s1+"'");
...
//	out.println("TEMPLATE<input type=text name=t1 value='"+s1+"'>");
	%>
	<div style="text-align: center">	
	<h2 align="center">EDIT TEMPLATE</h2>
	<input type="text" name="t1" value="<%=s1%>" readonly style="text-align: center">
<!-- 	<select name="sel" value="<%= s1 %>">
...
<br>
<div style="text-align: center;"><input type=submit name=t5 value=Edit></div>
</form>
</BODY>
</HTML>
<%! 
