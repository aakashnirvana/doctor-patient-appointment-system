...
<br>
<br>
<p class=heading align="center">Pending Patients</p>
<br>
<%
	try
	{
		...
		ResultSet rs=stmt.executeQuery("select * from login inner join patient_reg on login.username=patient_reg.username where login.type='P' and login.status='P'");
		rs.last();
		if(rs.getRow()==0)
		{
