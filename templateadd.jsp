...
Templetes Which You Alredy Have <select name=select>
...
<br><br><br>
<div>
	<form align=center action="http://127.0.0.1:8080/das/templateinsertdbms.jsp">
		Template Name <input type="text" name="t1" required>
...
<br>
<tr><td><input type="submit" name="t2" value="Add New"></td></tr>
</table>
