...
try{
   ...
   ResultSet rs;
		//	rs=stmt.executeQuery("select * FROM patient_reg ");//functionality
			...
			{    
				 ...
				 ph_home=rs.getString("mobile_No");
  ...
  %>
<table align=center style="border-style:solid; background-color:cyan;">
...
if(gender.equals("M"))
				 { %>
				 <td><input type="RADIO" value="M" name="a4" checked>Male
				
				                      <input type=radio name=a4 value="F">Female</td></tr>
				<% }
				 else
				 { %>
					<td><input type="RADIO" value="M" name="a4" >Male
				
				                      <input type=radio name=a4 value="F" checked>Female</td></tr>
				<% }%>
...
<%if(mrecord.equals("A"))
				 { %>
				 	             <td><input type="RADIO" value="Y" name="a6" checked>Available
				
				                      <input type=radio name=a6 value=NA>Not Available</td></tr>
				<% }
				 else
				 { %>
					
				 	             <td><input type="RADIO" value="Y" name="a6" >Available
				
				                      <input type=radio name=a6 value=NA checked>Not Available</td></tr>
				<% }%>

<tr><td><b>Password</b> </td><td><input type=password name ="a7" value="<%=password%>" size=20></td></tr>

<tr><td><hr></td></tr>
<tr><td><b>Mobile No.</b></td><td><input type=text name ="ac2" value="<%=ph_home%>" size=10></td></tr>
...
<tr><td><b>House_No</b></td><td><input type=text name="ac4"  value="<%=house_No%>"></td></tr>
<tr><td><b>Area</b></td><td><input type=text name="area"  value="<%=area%>"></td></tr>
<tr><td><b>City</b></td><td><input type=text name="ac5"  value="<%=city%>"></td></tr>
...
<%	if(hschool.equals("Y"))
				 ...
				 {%>
					<tr><td><b>High School(10th)</b></td><td><input type="RADIO" value="Y" name="aq1" checked="">Yes
                                         <input type="RADIO" value="N" name="aq1">No</td></tr><br>
				<% }
				 else
				 {%>
					  <tr><td><b>High School(10th)</b></td><td><input type="RADIO" value="Y" name="aq1">Yes
                                         <input type="RADIO" value="N" name="aq1" checked="">No</td></tr><br>
				<% }

if(intermediate.equals("Y"))

				 {%>
					<tr><td><b>Intermediate(12th)</b></td><td><input type="RADIO" value="Y" name="aq2" checked="">Yes
                                          <input type="RADIO" value="N" name="aq2">No</td></tr><br>
				<% }
				 else
				 {%>
					  <tr><td><b>Intermediate(12th)</b></td><td><input type="RADIO" value="Y" name="aq2">Yes
                                          <input type="RADIO" value="N" name="aq2" checked="">No</td></tr><br>
				<% }%>
...
<%if( pg.equals("on"))
				 ...
				 {%>
					<tr><td><b>Post Graduate</b></td><td><input type="RADIO" value="Y" name="aq4" checked="">Yes
                                     <input type="RADIO" value="N" name="aq4">No</td></tr><br>
				<% }
				 else
				 {%>
					  <tr><td><b>Post Graduate</b></td><td><input type="RADIO" value="Y" name="aq4">Yes
                                     <input type="RADIO" value="N" name="aq4" checked="">No</td></tr><br>
				<% }%>
