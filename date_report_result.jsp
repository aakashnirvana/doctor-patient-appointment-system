...
<body>
	...
	<%
		...
		try
		{
			...
			ResultSet rs=stmt.executeQuery("select * FROM patient_reg p,appointment_data a where (p.username=a.username AND date BETWEEN '"+fromdate+"' AND '"+todate+"')");
			rs.last();
			if(rs.getRow()==0)
			{
