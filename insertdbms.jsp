...
//out.println(v);
	...
	try
		...
		%>
		<br>
	 <h2 align=center class=bg>Schedule has been successfully entered </h2>
	 <br>
	 <h3 align=center class=bg> Do you want to update the Schedule..??</h3>
	 <br>
	 <table align=center>
	<input type=submit name=t3 value=update>
	</form>
<form action="http://127.0.0.1:8080/das/insert.jsp">
	<br>
	<br>
<input type=submit name=t4 value=cancel>
</form>
</table>
</BODY>
</HTML>
